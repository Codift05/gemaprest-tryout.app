                                ...
                                {imagePreview ? (
                                    ...
                                    >
                                        <div className="p-2.5 sm:p-3 bg-white rounded-full shadow-sm mb-2 sm:mb-3">
                                            <PhotoIcon className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-600" />
                                        </div>
                        ...
                        <div className="p-4 sm:p-8 space-y-4 sm:space-y-6">
                            <div className="grid grid-cols-1 gap-3 sm:gap-6">
                                {data.options.map((option, index) => (
                                    <div key={option.key} className={`flex items-start gap-2.5 sm:gap-4 p-3 sm:p-4 rounded-lg sm:rounded-xl border transition-all ${data.correct_answer === option.key ? 'border-emerald-500 bg-emerald-50/30' : 'border-gray-200 hover:border-emerald-200'}`}>
                                        <button
                                            type="button"
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <textarea
                                                ...
                                                rows={2}
                                                className={`w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-white border rounded-lg sm:rounded-xl focus:ring-emerald-500 focus:border-emerald-500 text-sm transition-all ${data.correct_answer === option.key
                                                    ? 'border-emerald-300'
                                                    : 'border-gray-200'
                                                    }`}
                        ...
                        <div className="p-4 sm:p-8 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-xl focus:border-emerald-500 focus:ring-emerald-500 text-sm transition-all"
                                >
