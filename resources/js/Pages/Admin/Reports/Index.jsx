                    ...
                    {reportCards.map((report, index) => {
                        const CardContent = () => (
                            <div className="flex items-start gap-3 sm:gap-5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="mt-3 sm:mt-4 flex items-center text-xs sm:text-sm font-semibold text-indigo-600 group-hover:translate-x-1 transition-transform">
                                        Lihat Laporan
                        ...
                        return report.route ? (
                            <Link
                                ...
                                className="group bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-6 hover:shadow-md hover:border-indigo-100 transition-all cursor-pointer block"
                            >
                                <CardContent />
                            </Link>
                        ) : (
                            <div
                                ...
                                className="group bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-6 hover:shadow-md hover:border-indigo-100 transition-all cursor-pointer"
                            >
                                <CardContent />
                            </div>
                        );
