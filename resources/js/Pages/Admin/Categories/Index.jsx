                                    ...
                                    <div className="p-3 sm:p-4 flex items-center gap-2 sm:gap-4 hover:bg-gray-50 transition-colors">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-xs text-gray-500 mt-0.5">
                                                {category.subcategories?.length || 0} subkategori • {category.questions_count || 0} soal
                                            </p>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-1 sm:gap-2 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
                                            <button
                                                ...
                                                className="hidden sm:flex px-3 py-1.5 bg-indigo-50 text-indigo-600 text-xs font-semibold rounded-lg hover:bg-indigo-100 transition-colors items-center gap-1"
                                            >
                                            ...
                                            <button
                                                onClick={() => openSubcategoryModal(null, category.id)}
                                                className="sm:hidden p-1.5 text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors"
                                            >
