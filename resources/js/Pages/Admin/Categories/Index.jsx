        ...
        <AdminLayout title="Kelola Kategori">
            ...
            <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm sm:text-base text-gray-500 mt-1">Organisasi materi dan soal tryout.</p>
                </div>
                <button
                    onClick={() => openCategoryModal()}
                    className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-emerald-600 text-white text-sm font-semibold rounded-xl hover:bg-emerald-700 transition-colors shadow-sm shadow-emerald-200"
                >
                        ...
                        {categories.map((category) => {
                            ...
                            return (
                                <div key={category.id} className="group">
                                    {/* Category Row */}
                                    <div className="p-3 sm:p-4 flex items-center gap-2 sm:gap-4 hover:bg-gray-50 transition-colors">
                                        <button
                                            onClick={() => toggleExpand(category.id)}
                                            className="p-1 sm:p-1.5 hover:bg-gray-200 rounded-lg text-gray-400 hover:text-gray-600 transition-colors"
                                        >
                                            {isExpanded ? (
                                        ...
                                        <div className="flex items-center gap-1 sm:gap-2 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
                                            <button
                                                ...
                                                className="hidden sm:flex px-3 py-1.5 bg-emerald-50 text-emerald-600 text-xs font-semibold rounded-lg hover:bg-emerald-100 transition-colors items-center gap-1"
                                            >
                                                <PlusIcon className="w-3.5 h-3.5" />
                                                <span className="hidden md:inline">Subkategori</span>
                                            </button>
                                            <button
                                                onClick={() => openSubcategoryModal(null, category.id)}
                                                className="sm:hidden p-1.5 text-emerald-600 hover:bg-emerald-50 rounded-lg transition-colors"
                                            >
                        ...
                        <form onSubmit={handleCategorySubmit} className="space-y-5">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <input
                                        ...
                                        value={categoryForm.data.color}
                                        onChange={(e) => categoryForm.setData('color', e.target.value)}
                                        className="flex-1 px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:border-emerald-500 focus:ring-0 text-sm transition-all uppercase"
                                        placeholder="#6366f1"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3 pt-2">
                                ...
                                <button
                                    ...
                                    className="flex-1 px-4 py-2.5 bg-emerald-600 text-white text-sm font-semibold rounded-xl hover:bg-emerald-700 transition-colors shadow-sm shadow-emerald-200"
                                >
                        ...
                        <form onSubmit={handleSubcategorySubmit} className="space-y-5">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:border-emerald-500 focus:ring-0 text-sm transition-all cursor-pointer"
                                >
                                    {categories.map((cat) => (
