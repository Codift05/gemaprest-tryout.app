                ...
                <div className="flex flex-col gap-3 sm:gap-4">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-9 sm:pl-10 pr-4 py-2 sm:py-2.5 bg-gray-50 border border-gray-200 rounded-lg sm:rounded-xl focus:border-emerald-500 focus:ring-0 text-sm transition-all"
                    ...
                    <div className="flex gap-2 sm:gap-3">
                        <select
                            ...
                            className="flex-1 px-3 sm:px-4 py-2 sm:py-2.5 bg-gray-50 border border-gray-200 rounded-lg sm:rounded-xl focus:border-emerald-500 focus:ring-0 text-sm transition-all cursor-pointer"
                        >
                                    ...
                                    <tr key={user.id} className="hover:bg-gray-50/50 transition-colors">
                                        <td className="px-4 sm:px-6 py-3 sm:py-4">
                                            <div className="flex items-center gap-2 sm:gap-3">
                                                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-emerald-50 border border-emerald-100 rounded-full flex items-center justify-center text-emerald-600 font-bold text-xs sm:text-sm">
