                        ...
                        <form onSubmit={handleSubmit} className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 flex flex-col min-h-[400px] sm:min-h-[500px]">
                                    ...
                                    <div className="space-y-4 sm:space-y-6">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:border-emerald-500 focus:ring-0 text-sm transition-all"
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                rows={3}
                                                className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:border-emerald-500 focus:ring-0 text-sm transition-all resize-none"
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                <input
                                                    ...
                                                    min="10"
                                                    max="300"
                                                    className="w-full pl-4 pr-12 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:border-emerald-500 focus:ring-0 text-sm transition-all"
                                                />
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-4">
                                            <input
                                                ...
                                                min="1"
                                                max="10"
                                                className="w-24 px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:border-emerald-500 focus:ring-0 text-sm transition-all"
                                            />
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                        <div className="flex items-center justify-between p-4 sm:p-5 bg-gray-50 rounded-lg sm:rounded-xl border border-gray-100">
                                            ...
                                            <button
                                                ...
                                                className={`relative inline-flex h-7 w-12 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${data.enable_proctoring ? 'bg-emerald-600' : 'bg-gray-200'
                                                    }`}
                                            >
                                                <span
                                        ...
                                        <div className="flex items-center justify-between p-4 sm:p-5 bg-gray-50 rounded-lg sm:rounded-xl border border-gray-100">
                                            ...
                                            <button
                                                ...
                                                className={`relative inline-flex h-7 w-12 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${data.enable_fullscreen ? 'bg-emerald-600' : 'bg-gray-200'
                                                    }`}
                                            >
                                                <span
                                    ...
                                    <div className="flex flex-col items-center justify-center py-8 sm:py-12 bg-gray-50 rounded-lg sm:rounded-xl border border-dashed border-gray-200">
                                        ...
                                        <div className="w-full max-w-md bg-gray-800 rounded-lg sm:rounded-xl p-4 sm:p-5 text-left shadow-lg mx-4">
                                            ...
                                            <code className="text-xs font-mono text-gray-300 space-y-1 block">
                                                <div><span className="text-emerald-400">MAIL_MAILER</span>=smtp</div>
                                                <div><span className="text-emerald-400">MAIL_HOST</span>=smtp.mailgun.org</div>
                                                <div><span className="text-emerald-400">MAIL_PORT</span>=587</div>
                                                <div><span className="text-emerald-400">MAIL_USERNAME</span>=...</div>
                                                <div><span className="text-emerald-400">MAIL_PASSWORD</span>=...</div>
                                                <div><span className="text-emerald-400">MAIL_ENCRYPTION</span>=tls</div>
                                            </code>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="px-4 sm:px-8 py-4 sm:py-5 bg-gray-50/50 border-t border-gray-100 rounded-b-xl sm:rounded-b-2xl flex justify-end">
                                <button
                                    type="submit"
                                    disabled={processing}
                                    className="px-6 py-2.5 bg-emerald-600 text-white font-semibold rounded-xl hover:bg-emerald-700 disabled:opacity-50 transition-all shadow-sm shadow-emerald-200"
                                >
