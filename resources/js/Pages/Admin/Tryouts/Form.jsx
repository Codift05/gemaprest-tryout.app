            ...
            <div className="max-w-4xl mx-auto pb-8 sm:pb-12">
                ...
                <div className="mb-6 sm:mb-8">
                    <Link
                        ...
                        className="inline-flex items-center text-sm font-medium text-gray-500 hover:text-emerald-600 mb-3 sm:mb-4 transition-colors p-1.5 sm:p-2 -ml-1.5 sm:-ml-2 rounded-lg hover:bg-emerald-50"
                    >
                ...
                <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-8">
                        ...
                        <div className="p-4 sm:p-8 space-y-5 sm:space-y-6">
                                ...
                                {thumbnailPreview ? (
                                    ...
                                    <label
                                        className={`flex flex-col items-center justify-center w-full h-48 sm:h-64 border-2 border-dashed rounded-xl sm:rounded-2xl cursor-pointer transition-all duration-200 ${isDragOver
                                            ...
                                            : 'border-gray-300 bg-gray-50 hover:bg-white hover:border-emerald-400'
                                            }`}
                                    ...
                                    >
                                        <div className="p-3 sm:p-4 bg-white rounded-full shadow-sm mb-2 sm:mb-3">
                                            <PhotoIcon className="w-6 h-6 sm:w-8 sm:h-8 text-emerald-600" />
                                        </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-2.5 rounded-xl border-gray-200 focus:border-emerald-500 focus:ring-emerald-500 transition-colors ${errors.title ? 'border-red-500 focus:ring-red-500' : ''}`}
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={4}
                                    className="w-full px-4 py-3 rounded-xl border-gray-200 focus:border-emerald-500 focus:ring-emerald-500 transition-colors resize-none"
                                                ...
                                                return (
                                                    <div key={cat.id} className="flex items-center justify-between gap-4">
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-20 px-3 py-1.5 text-sm rounded-lg border-gray-200 focus:border-emerald-500 focus:ring-emerald-500"
                                                            placeholder="0"
                                                        />
                                                    </div>
                                                );
                        ...
                        <div className="p-4 sm:p-8 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-2.5 rounded-xl border-gray-200 focus:border-emerald-500 focus:ring-emerald-500"
                                    />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 rounded-xl border-gray-200 focus:border-emerald-500 focus:ring-emerald-500"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full pl-4 pr-10 py-2.5 rounded-xl border-gray-200 focus:border-emerald-500 focus:ring-emerald-500"
                                    />
                            ...
                            {[
                                ...
                                <label key={key} className="flex items-center justify-between cursor-pointer group p-2 sm:p-3 -mx-2 sm:-mx-3 rounded-lg sm:rounded-xl hover:bg-gray-50 transition-colors gap-3">
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm sm:text-base font-semibold text-gray-900 group-hover:text-emerald-600 transition-colors">{label}</p>
                                    ...
                                    <div className="relative inline-flex items-center cursor-pointer flex-shrink-0">
                                        ...
                                        />
                                        <div className="w-10 h-6 sm:w-12 sm:h-7 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-emerald-100 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 sm:after:h-6 sm:after:w-6 after:transition-all peer-checked:bg-emerald-600"></div>
                                    </div>
                                </label>
                            ))}
                        </div>
                    ...
                    <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-3 sm:gap-4 pt-4 border-t border-gray-100">
                        ...
                        <button
                            type="submit"
                            disabled={processing}
                            className="px-5 sm:px-6 py-2.5 rounded-lg sm:rounded-xl bg-emerald-600 text-white font-medium hover:bg-emerald-700 focus:ring-4 focus:ring-emerald-100 transition-all shadow-sm hover:shadow-md disabled:opacity-70 disabled:cursor-not-allowed text-sm sm:text-base"
                        >
