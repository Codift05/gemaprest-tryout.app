                ...
                <div className="mb-6">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition-colors font-medium shadow-sm flex items-center"
                        >
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
                    ...
                    {assignedQuestions.length === 0 ? (
                        <div className="p-12 text-center">
                            ...
                            <button
                                onClick={() => setShowAddModal(true)}
                                className="px-4 py-2 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition-colors font-medium shadow-sm inline-flex items-center"
                            >
                                <PlusIcon className="w-5 h-5 mr-2" />
                                Tambah Soal
                            </button>
                    ...
                    <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[80vh] flex flex-col">
                        ...
                        <div className="p-4 border-b bg-gray-50 space-y-3">
                            ...
                            <div className="flex gap-3">
                                ...
                                <select
                                    ...
                                    className="flex-1 px-4 py-2 bg-white border border-gray-200 rounded-xl focus:border-emerald-500 focus:ring-emerald-500 text-sm transition-all"
                                >
                        ...
                        <div className="p-4 border-t flex items-center justify-end gap-4">
                            ...
                            <button
                                ...
                                className="px-4 py-2 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition-colors font-medium shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                            >
