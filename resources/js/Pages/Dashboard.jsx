    ...
    return (
        <MainLayout title="Dashboard">
            ...
            <div className="space-y-8">
                {/* Welcome Section */}
                <div className="glass-card p-8 rounded-2xl bg-gradient-to-r from-primary-500/10 to-accent-500/10 border border-white/20">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">Lanjutkan persiapan UTBK kamu hari ini</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="glass-card p-6 rounded-2xl hover:shadow-xl transition-all duration-300 group">
                        <div className="flex items-center gap-4">
                            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center shadow-lg shadow-primary-500/30 group-hover:scale-110 transition-transform">
                                        ...
                                        <tr key={result.id} className="hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td className="px-6 py-4">
                                                <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold ${
                                                    result.percentage >= 70 ? 'bg-emerald-100 text-emerald-700' :
...
function TryoutCard({ tryout }) {
    return (
        <div className="glass-card rounded-2xl overflow-hidden group hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            {/* Thumbnail */}
            <div className="h-44 bg-gradient-to-br from-primary-500 to-accent-600 relative overflow-hidden">
                {tryout.thumbnail && (
                    <img
