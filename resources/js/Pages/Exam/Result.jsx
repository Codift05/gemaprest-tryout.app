        ...
        <MainLayout>
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="text-center mb-6 md:mb-10">
                    ...
                    <h1 className="text-xl md:text-4xl font-extrabold text-gray-900 mb-2 tracking-tight">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
                    ...
                    <div className="lg:col-span-3">
                        <div className="bg-white rounded-2xl md:rounded-3xl shadow-sm border border-gray-100 overflow-hidden relative group hover:shadow-md transition-all duration-300">
                            ...
                            <div className="p-5 md:p-10 relative z-10">
                                <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-16">
                                    ...
                                    <div className="relative flex-shrink-0">
                                        <div className="w-32 h-32 md:w-48 md:h-48 rounded-full flex items-center justify-center bg-white shadow-[0_0_40px_-10px_rgba(0,0,0,0.05)] border-4 border-gray-50">
                                            <div className="text-center">
                                                <span className={`block text-4xl md:text-6xl font-black ${getScoreColor(score)} tracking-tighter`}>
                                                    {score}%
                                                </span>
                                    ...
                                    <div className="text-center md:text-left max-w-lg">
                                        ...
                                        <p className="text-gray-500 leading-relaxed mb-4 md:mb-8 text-sm md:text-base">
                                            {score >= 60
                                        ...
                                        <div className="grid grid-cols-3 gap-2 md:gap-4">
                                            <div className="flex flex-col items-center md:items-start p-2.5 md:p-4 bg-emerald-50/50 rounded-xl md:rounded-2xl border border-emerald-100/50 hover:bg-emerald-50 transition-colors">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <CheckCircleIcon className="w-4 h-4 text-emerald-600" />
                                                    <span className="text-xs font-bold text-emerald-800 uppercase tracking-wide">Benar</span>
                                                </div>
                                                <span className="text-lg md:text-2xl font-bold text-emerald-600">{stats.correct}</span>
                                            </div>
                                            <div className="flex flex-col items-center md:items-start p-2.5 md:p-4 bg-red-50/50 rounded-xl md:rounded-2xl border border-red-100/50 hover:bg-red-50 transition-colors">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <XCircleIcon className="w-4 h-4 text-red-600" />
                                                    <span className="text-xs font-bold text-red-800 uppercase tracking-wide">Salah</span>
                                                </div>
                                                <span className="text-lg md:text-2xl font-bold text-red-600">{stats.incorrect}</span>
                                            </div>
                                            <div className="flex flex-col items-center md:items-start p-2.5 md:p-4 bg-gray-50 rounded-xl md:rounded-2xl border border-gray-100 hover:bg-gray-100 transition-colors">
                                                <div className="flex items-center gap-2 mb-1">
                                                ...
                                                <span className="text-lg md:text-2xl font-bold text-gray-600">{stats.unanswered}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                {/* Action Buttons */}
                <div className="flex flex-col sm:flex-row flex-wrap gap-3 md:gap-4 justify-center py-6 md:py-8">
                    <Link
                        href={route('dashboard')}
                        className="inline-flex items-center justify-center px-5 py-3 md:px-8 md:py-4 rounded-xl md:rounded-2xl text-sm font-bold text-gray-700 bg-white border border-gray-200 shadow-sm hover:shadow-md hover:bg-gray-50 hover:-translate-y-0.5 transition-all duration-200"
                    >
                    ...
                    {tryout.allow_review && (
                        <Link
                            ...
                            className="inline-flex items-center justify-center px-5 py-3 md:px-8 md:py-4 rounded-xl md:rounded-2xl text-sm font-bold text-white bg-blue-600 shadow-lg shadow-blue-200 hover:shadow-xl hover:shadow-blue-300 hover:bg-blue-700 hover:-translate-y-0.5 transition-all duration-200"
                        >
                    ...
                    {tryout.can_attempt && (
                        <Link
                            ...
                            className="inline-flex items-center justify-center px-5 py-3 md:px-8 md:py-4 rounded-xl md:rounded-2xl text-sm font-bold text-indigo-600 bg-indigo-50 border border-indigo-100 hover:bg-indigo-100 hover:border-indigo-200 hover:-translate-y-0.5 transition-all duration-200"
                        >
